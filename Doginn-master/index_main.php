...
<div class="contenedor-principal"> <!-- Agregado el contenedor principal -->
    ...
    <form id="searchForm" class="buscadorhorizontal-form">
        <div class="buscadorinput-container">
            ...
            <div class="buscadorinput-with-icon">
                ...
                <img class="buscadorimg" src="https://th.bing.com/th/id/OIG1.It9qlarBC8CHe13J8cFS?w=1024&h=1024&rs=1&pid=ImgDetMain" alt="Icono de ubicación">
            </div>
        </div>
        ...
        <div class="buscadorinput-container">
            ...
            <div class="buscadorinput-with-icon">
                ...
                <img class="buscadorimg" src="https://th.bing.com/th/id/OIG1.g4ebEh7HGHpw9cJEu3Az?w=270&h=270&c=6&r=0&o=5&dpr=1.3&pid=ImgGn" alt="Icono de calendario">
            </div>
        </div>
        ...
        <div class="buscadorinput-container">
            <label class="buscadorlabel" for="numDogs">Perros:</label>
            <div class="buscadorinput-with-icon">
                <input class="buscadorinput" type="number" id="numDogs" name="numDogs" min="1" value="1" required>
                <img class="buscadorimg" src="https://th.bing.com/th/id/OIG2..bmTeouaX06pdVVbosoK?w=270&h=270&c=6&r=0&o=5&dpr=1.3&pid=ImgGn" alt="Icono de perro">
            </div>
        </div>
    ...
    <script src="buscador.js"></script> <!-- Asegúrate de que este archivo exista y contenga tu JavaScript -->
</body>
