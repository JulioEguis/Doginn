...
<body>
    <div class="container">
        ...
        <!-- <form action="#" method="POST"> -->
            ...
            <!-- </div> -->
            <button onclick="location.href='registro_exitoso.html'" class="btn-continuar">Registrate</button>
        </form>
        <div class="alt-login">
            <p>o</p>
            <button class="btn-facebook">Registrate con Facebook ( en construcción )</button>
            <button class="btn-google">Registrate con Google ( en construcción )</button>
           
            <!-- <button class="btn-email">Continúa con el correo electrónico</button> -->
            <button onclick="location.href='registro_exitoso.html'" class="btn-email">Registrate con el correo electrónico</button>
        </div>
    </div>
