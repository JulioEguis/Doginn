...
// Obtener reservas de la guardería
$query_reservas = "
    SELECT 
        reservas.id_reserva, 
        usuarios.nombre, 
...
<head>
    ...
    <title>Reservas de Mi Guardería</title>
...
<body>
    <div class="container">
        <h1 style="text-align: center;">Reservas de Mi Guardería</h1>
            ...
            <table>
                ...
                <?php while ($reserva = $resultado_reservas->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><a href="mis_facturas_guarderias.php?id_reserva=<?php echo $reserva['id_reserva']; ?>">Ver factura</a></td>
                    </tr>
                <?php endwhile; ?>
            </table>
        <?php else: ?>
            <p style="text-align: center;">No hay reservas realizadas en esta guardería.</p>
        <?php endif; ?>
